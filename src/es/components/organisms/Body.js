...
export default class Body extends BaseBody {
  renderCSS () {
    ...
    this.css = /* css */`
      ...
      :host > main a[href^="/"]:before, :host > main a[href$=".pdf"]:before, :host > main a[href$=".xls"]:before {
      ...
      :host > main a[href^="/"]:hover:before, :host > main a[href$=".pdf"]:hover:before, :host > main a[href$=".xls"]:hover:before {
